        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <div class="box-tools pull-right">
                    <ul class="pagination">
                        <li>
                            <a href="${pageContext.request.contextPath}/borrow/findAll.do" aria-label="Previous">
                                首页
                            </a>
                        </li>
                        <c:if test="${pageInfo.currentPage-1>0}">
                            <li>
                                <a href="${pageContext.request.contextPath}/borrow/findAll.do?currentPage=${pageInfo.currentPage-1}">
                                    上一页
                                </a>
                            </li>
                        </c:if>
                        ...
                        <c:forEach begin = "1" end="${pageInfo.totalPage}" var="pageNum">
                            <li>
                                <a href="${pageContext.request.contextPath}/borrow/findAll.do?currentPage=${pageNum}">
                                        ${pageNum}
                                </a>
                            </li>
                        </c:forEach>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/borrow/findAll.do?currentPage=${pageInfo.totalPage}" aria-label="Next">
                                尾页
                            </a>
                        </li>
                    </ul>
