...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/role/updateRole.do" method="post">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="id"
                                   placeholder="id" value="${role.id}" readonly="true">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="desc"
                                   placeholder="请输入角色描述" value="${role.desc}">
                        </div>
                    </div>
                </div>
