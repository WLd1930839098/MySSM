				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<form action="${pageContext.request.contextPath}/user/findAllUsers.do?type=1" method="post">
								...
								<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/toUpdateUser.do?id=${user.id}" class="btn bg-olive btn-xs">
													更新
												</a>

												<a href="${pageContext.request.contextPath}/user/deleteUserById.do?id=${user.id}" class="btn bg-olive btn-xs">
													删除
												</a>

												<a href="${pageContext.request.contextPath}/user/toAddRoleToUser.do?id=${user.id}" class="btn bg-olive btn-xs">
													添加角色
												</a>
					...
					<!-- /.box-body -->
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="${pageContext.request.contextPath}/user/findAllUsers.do?currentPage=1" aria-label="Previous">
										首页
									</a>
								</li>
								<c:if test="${pageInfo.currentPage-1>0}">
									<li>
										<a href="${pageContext.request.contextPath}/user/findAllUsers.do?currentPage=${pageInfo.currentPage-1}">
											上一页
										</a>
									</li>
								</c:if>
								...
								<c:forEach begin = "1" end="${pageInfo.totalPage}" var="pageNum">
									<li>
										<a href="${pageContext.request.contextPath}/user/findAllUsers.do?currentPage=${pageNum}">
												${pageNum}
										</a>
									</li>
								</c:forEach>
								...
								<li>
									<a href="${pageContext.request.contextPath}/user/findAllUsers.do?currentPage=${pageInfo.totalPage}" aria-label="Next">
										尾页
									</a>
								</li>
							</ul>
